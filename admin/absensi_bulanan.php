      ...
      <div id="content">
        ...
        <div class="container-fluid bg-body-tertiary" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0">Absensi Bulanan Siswa</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Absensi Bulanan Siswa</li>
            </ol>
          </div>
          ...
          <div class="container bg-body-tertiary py-3 mb-5" id="absensi_bulanan">
            <form action="#absensi_bulanan" method="GET">
              <div class="input-group mb-3">
                ...
                <select class="form-select" name="filter_kelas_month">
                  <?php
                  $kelasid_wali = $_SESSION['kelasid'];
                  ...
                  if ($_SESSION['role'] == "Admin" || $_SESSION['role'] == "Kepala Sekolah") {
                    ...
                    while ($data_kelas = mysqli_fetch_array($sql_kelas)) {
                  ?>
                      <option value="<?= $data_kelas['namakelas'] ?>" <?php echo isset($_GET['filter_kelas_month']) && $_GET['filter_kelas_month'] == $data_kelas['namakelas'] ? 'selected' : ''; ?>><?= $data_kelas['namakelas'] ?></option>
                    <?php
                    }
                  } else if ($_SESSION['role'] == "Wali Kelas") {
            ...
            <div class="row">
              ...
              $filter_kelas_month = isset($_GET['filter_kelas_month']) ? $_GET['filter_kelas_month'] : '';
              ...
              if (!empty($filter_month)) {
                ...
                $kelasid = $_SESSION['kelasid'];
                if (isset($_GET['filter_kelas_month'])) {
                  $kelas = $_GET['filter_kelas_month'];
                  $sql .= " AND kelas.namakelas = '$kelas'";
                } else {
                  // $current_month = date('m');
                  // $current_year = date('Y');
                  // $sql .= " AND kelas.kelasid = '$kelasid' AND MONTH(absen.tanggal) = '$current_month' AND YEAR(absen.tanggal) = '$current_year'";
              ...
              } elseif (empty($filter_kelas_month)) {
                // $current_month = date('m');
                // $current_year = date('Y');
              ...
              if (!empty($filter_kelas_month)) {
                $sql .= " AND kelas.namakelas = '$filter_kelas_month'";
              }
